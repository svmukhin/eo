...
```text
to-java.xsl              77928  37.67%
classes.xsl              56940  27.53%
set-locators.xsl         18969  9.17%
set-original-names.xsl   12719  6.15%
attrs.xsl                10687  5.17%
data.xsl                 9163   4.43%
tests.xsl                6859   3.32%
anonymous-to-nested.xsl  6859   3.32%
package.xsl              6719   3.25%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-21 at 19:34,
on Linux with 4 CPUs.
The total is 206843 milliseconds.
...
[benchmark-gha]: https://github.com/svmukhin/eo/actions/runs/19581181684
